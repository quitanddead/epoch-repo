...
[_crate] execVM "missions\misc\fillBoxesM.sqf";
_crate setVariable ["Sarge",1,true];

_crate2 = createVehicle ["USLaunchersBox",[(_coords select 0) - 8, _coords select 1,0],[], 0, "CAN_COLLIDE"];
[_crate2] execVM "missions\misc\fillBoxesS.sqf";
_crate2 setVariable ["Sarge",1,true];


[[(_coords select 0) - 20, (_coords select 1) - 15,0],40,4,2,0] execVM "missions\add_unit_server2.sqf";//AI Guards
sleep 3;
[[(_coords select 0) + 10, (_coords select 1) + 15,0],40,4,2,0] execVM "missions\add_unit_server2.sqf";//AI Guards
sleep 3;
[[(_coords select 0) - 10, (_coords select 1) - 15,0],40,4,2,0] execVM "missions\add_unit_server2.sqf";//AI Guards
sleep 3;
[[(_coords select 0) + 20, (_coords select 1) + 15,0],40,4,2,0] execVM "missions\add_unit_server2.sqf";//AI Guards
...
SM1 = 1;
[0] execVM "missions\minor\SMfinder.sqf";
